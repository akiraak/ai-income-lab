...
- 2026-09-16 まばらな 0 埋め系列の `z20` が古い値を引きずる穴を塞いだ（`ex_` / `im_` 層）— ⚠ **§9 と §13 の結論は変わらなかった**
  - プラン: [docs/plans/archive/exog-z20-stale.md](docs/plans/archive/exog-z20-stale.md) / ⚠ **記録: [daily-data-sources.md §14](docs/specs/experiments/daily-data-sources.md)**（§9-2・§9-3・§12-6・§13 も訂正）
  ...
  - ⚠ **災害の 5 本は 2018-05-21 始まり・131,250 行で揃い、`start_date` を 06-15 から元に戻した**。同日に足した `gpu-models.md` §1 の注記も外した
