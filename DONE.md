# DONE
- 2026-09-18 管理画面に必要な機能を決める — Phase 3: 突き合わせて、決定表の下書きを作った [plan](docs/plans/dashboard-required-features.md)
...
- 2026-09-18 管理画面に必要な機能を決める — Phase 2: いまある機能を棚卸しした（旧「現在の機能を列挙して、必要・不要を決める」） [plan](docs/plans/dashboard-required-features.md)
...
- 2026-09-18 管理画面に必要な機能を決める — Phase 1: 使う場面を書き出した [plan](docs/plans/dashboard-required-features.md)
