...
| 画面 | 用途 | 起動 |
| --- | --- | --- |
| [dashboard/](dashboard/) | **売買システムの管理画面**。tastytrade の口座・注文・認証の監視、API 検証の記録と 6 観点の判定、開発時の検証。仕様は [docs/specs/dashboard.md](docs/specs/dashboard.md) | `./run-server.sh` → http://127.0.0.1:3012（⚠ ポートを掴んでいるプロセスを止めてから起動する） |
