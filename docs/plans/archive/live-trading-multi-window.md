...
親: [実売買のプラン](../live-trading-three-models.md)。関連: [live-trading.md §0-2（発注できる時間帯と上限）・§0-6（規制の線）・§0-7 (k)（自動テスト）](../../specs/experiments/live-trading.md)・[dashboard.md §13](../../specs/dashboard.md)。
...
| **6** | 仕様: §0-2（発注できる時間帯・上限・C9）・§0-6 の含意の表・§0-7 (k)・CLAUDE.md | 0.5 日【推測】 |
...
| `docs/specs/experiments/live-trading.md`・`CLAUDE.md` | §0-2・§0-6 の含意・§0-7 (k) |
