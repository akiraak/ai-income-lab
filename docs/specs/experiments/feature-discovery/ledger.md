...
⚠ **試行は 421 行（手法）＋ 251 行（基準線）。** ⚠ **「採る」は 0 件。** 落とす 345 行 ／ 保留 76 行。
...
⚠ **多重検定に使う `n_trials` は 421**（= 試行の行数。基準線 251 行は数えない。⚠ **「全部使う × Ridge 以外のモデル」はモデルが処置なので試行として数える** — [plans/archive/gpu-models.md §3-4](../../../plans/archive/gpu-models.md)）。⚠ **[rules.md 11 章](rules.md) の規約 4 は「手法 × 粒度 × 地平 × 銘柄集合」を全部数えることを求める。この数を数え落とすと必ず甘くなる。**
...
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 50 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 3 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-13T09-59-21_trade_own_mlp_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 60 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 3 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-13T09-59-21_trade_own_mlp_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 55 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 3 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-13T09-59-21_trade_own_mlp_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 50 | 16.0 | 0.5207 | −0.0194 | ＋1608.78 | **＋1588.10** | 1/5 0＋−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-13T08-57-48_trade_own_lgbm_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 50 | 35.0 | 0.5199 | −0.0028 | ＋1537.93 | **＋1509.88** | 1/5 0＋−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -142.14bp ≤ 0。rules.md 13-7） | `2026-09-13T08-57-48_trade_own_lgbm_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 55 | 35.0 | 0.5199 | −0.0028 | ＋1243.51 | **＋1234.76** | 2/5 0＋−−＋ | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -417.25bp ≤ 0。rules.md 13-7） | `2026-09-13T08-57-48_trade_own_lgbm_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 55 | 16.0 | 0.5207 | −0.0194 | ＋1172.47 | **＋1165.47** | 1/5 0−−−＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-13T08-57-48_trade_own_lgbm_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 60 | 35.0 | 0.5199 | −0.0028 | ＋401.30 | **＋397.46** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1254.56bp ≤ 0。rules.md 13-7） | `2026-09-13T08-57-48_trade_own_lgbm_a` |
| — | 乱択（基準） | 基準線 | ✅ | LightGBM | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 60 | 16.0 | 0.5207 | −0.0194 | ＋388.41 | **＋385.08** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-13T08-57-48_trade_own_lgbm_a` |
...
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 50 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 3 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-13T09-59-21_trade_own_mlp_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 55 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 3 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-13T09-59-21_trade_own_mlp_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 60 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 3 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-13T09-59-21_trade_own_mlp_a` |
...
| — | 全部使う（基準） | LightGBM | adjusted | 日足 | 0.9988 | ＋0.6650 | ＋24298.12 | ＋23845.05 | `2026-09-13T08-59-45_trade_own_lgbm_a_leak` |
| — | 全部使う（基準） | LightGBM | adjusted | 日足 | 0.9988 | ＋0.6650 | ＋24298.16 | ＋23844.80 | `2026-09-13T08-59-45_trade_own_lgbm_a_leak` |
...
| — | 全部使う（基準） | LightGBM | adjusted | 日足 | 0.9988 | ＋0.6650 | ＋24298.21 | ＋23844.42 | `2026-09-13T08-59-45_trade_own_lgbm_a_leak` |
...
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-10T20-06-42_trade_own_lgbm_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-10T20-06-42_trade_own_lgbm_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-13T10-02-22_trade_own_mlp_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-13T10-02-22_trade_own_mlp_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-13T10-02-22_trade_own_mlp_a_leak` |
...
| — | 乱択（基準） | LightGBM | adjusted | 日足 | 0.5201 | ＋0.0173 | ＋1515.77 | ＋1498.14 | `2026-09-13T08-59-45_trade_own_lgbm_a_leak` |
...
| — | 乱択（基準） | LightGBM | adjusted | 日足 | 0.5201 | ＋0.0173 | ＋968.04 | ＋961.83 | `2026-09-13T08-59-45_trade_own_lgbm_a_leak` |
...
| — | 乱択（基準） | LightGBM | adjusted | 日足 | 0.5201 | ＋0.0173 | ＋278.97 | ＋276.56 | `2026-09-13T08-59-45_trade_own_lgbm_a_leak` |
...
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-10T20-06-42_trade_own_lgbm_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-10T20-06-42_trade_own_lgbm_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-13T10-02-22_trade_own_mlp_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-13T10-02-22_trade_own_mlp_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-13T10-02-22_trade_own_mlp_a_leak` |
...
| 3 | ⚠ **「未実施」は「効かない」ではない** | ⚠ **12 件は情報が無いだけである。**⚠ **落とした 345 行と混同しない** |
