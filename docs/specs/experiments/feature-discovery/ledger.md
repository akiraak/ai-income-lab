...
生成日 2026-09-15 ／ 入口: [feature-discovery.md](../feature-discovery.md) ／ 規約: [rules.md](rules.md) ／ 手法のカタログ: [feature-discovery.md §2](../feature-discovery.md#2-特徴量を見つけ出す手法のカタログphase-25-系統-25-件)
...
⚠ **カタログ 26 件のうち、実装したのは 14 件、実際に回したのは 14 件。** 残り 12 件は**未実施**である（§3）。

⚠ **試行は 571 行（手法）＋ 356 行（基準線）。** ⚠ **「採る」は 0 件。** 落とす 493 行 ／ 保留 78 行。

⚠ **保留の内訳**: 無効・要再測（日足 × `raw`）が 27 行 ／ ⚠ **純利は正だが fold の符号が割れる**ものが 51 行。⚠ **後者は「採る」の一歩手前ではない。** ⚠ **多重検定を通していない良い数字である**（[rules.md 11 章](rules.md) 規約 2・3）。
...
⚠ **多重検定に使う `n_trials` は 571**（= 試行の行数。基準線 356 行は数えない。⚠ **「全部使う × Ridge 以外のモデル」はモデルが処置なので試行として数える** — [plans/archive/gpu-models.md §3-4](../../../plans/archive/gpu-models.md)）。⚠ **[rules.md 11 章](rules.md) の規約 4 は「手法 × 粒度 × 地平 × 銘柄集合」を全部数えることを求める。この数を数え落とすと必ず甘くなる。**
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 32.0 | 0.5186 | ＋0.0181 | ＋1782.66 | **＋1731.00** | 2/5 00＋−＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T07-42-56_trade_ownex_lgbmgan16k_a` |
...
| — | T3 QUANT（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 50 | 60.0 | 0.5219 | ＋0.0070 | ＋1743.57 | **＋1713.93** | 2/5 ＋＋−−0 | — | **保留** | ⚠ 上乗せの平均だけ正（+61.92bp）。fold の符号が割れる（rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
...
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 50 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 12 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T09-48-15_trade_own_lgbm_sel7_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 60 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 12 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T09-48-15_trade_own_lgbm_sel7_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 55 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 12 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T09-48-15_trade_own_lgbm_sel7_a` |
...
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 50 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 2 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T14-04-35_trade_ownseq_patchtst_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 55 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 2 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T14-04-35_trade_ownseq_patchtst_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 60 | 0.0 | 0.5216 | 0.0000 | ＋1657.02 | **＋1652.02** | 0/5 00000 | 2 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T14-04-35_trade_ownseq_patchtst_a` |
...
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 0.0 | 0.5174 | 0.0000 | ＋1656.01 | **＋1650.62** | 0/5 00000 | 9 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 0.0 | 0.5174 | 0.0000 | ＋1656.01 | **＋1650.62** | 0/5 00000 | 9 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 0.0 | 0.5174 | 0.0000 | ＋1656.01 | **＋1650.62** | 0/5 00000 | 9 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 0.0 | 0.5174 | 0.0000 | ＋1656.01 | **＋1650.62** | 0/5 00000 | 9 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 0.0 | 0.5174 | 0.0000 | ＋1656.01 | **＋1650.62** | 0/5 00000 | 9 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 0.0 | 0.5174 | 0.0000 | ＋1656.01 | **＋1650.62** | 0/5 00000 | 9 実行・一致 | 基準 | ⚠ 新方式では期初買い・期末売り（B&H）。上乗せの基準 | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM | adjusted | 2018-06-27 | 日足 | 1 本（1 日） | own cs rel ll | 閾値売買 | 共通 | std | 50 | 134.0 | 0.5139 | ＋0.0054 | ＋1732.27 | **＋1610.23** | 3/5 ＋＋＋−0 | — | **保留** | ⚠ 上乗せの平均だけ正（+64.54bp）。fold の符号が割れる（rules.md 13-7） | `2026-09-13T12-08-05_trade_cs_lgbm_a` |
...
| — | T2 Hydra（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 50 | 60.0 | 0.5206 | −0.0058 | ＋1594.79 | **＋1588.20** | 1/5 0＋−−0 | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -63.81bp ≤ 0。rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 124.0 | 0.5101 | −0.0283 | ＋1588.29 | **＋1580.68** | 1/5 0−−−＋ | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -69.93bp ≤ 0。rules.md 13-7） | `2026-09-15T00-50-28_trade_ownex_mlpgan_a` |
...
| — | T1 MiniRocket（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 50 | 60.0 | 0.5203 | ＋0.0035 | ＋1579.19 | **＋1567.32** | 1/5 0＋−−0 | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -84.70bp ≤ 0。rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 32.0 | 0.5124 | ＋0.0236 | ＋1635.55 | **＋1525.02** | 4/5 −＋＋＋＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T23-35-59_trade_ownex_lgbmgan_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 32.0 | 0.5112 | −0.0154 | ＋1503.96 | **＋1492.20** | 1/5 −−−−＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T20-07-00_trade_ownex_ridgegan_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 32.0 | 0.5091 | ＋0.0343 | ＋1492.79 | **＋1468.85** | 1/5 0−−−＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T07-19-47_trade_ownex_ridgegan16k_a` |
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 32.0 | 0.5186 | ＋0.0181 | ＋1491.35 | **＋1461.62** | 2/5 0−＋−＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T07-42-56_trade_ownex_lgbmgan16k_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 50 | 35.0 | 0.5184 | −0.0021 | ＋1467.52 | **＋1381.12** | 2/5 −＋−−＋ | 2 実行・一致 | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -270.89bp ≤ 0。rules.md 13-7） | `2026-09-15T09-42-43_trade_own_ridge_sel7_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 124.0 | 0.5111 | ＋0.0057 | ＋1366.19 | **＋1361.01** | 2/5 ＋−−−＋ | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -289.60bp ≤ 0。rules.md 13-7） | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 32.0 | 0.5127 | ＋0.0076 | ＋1467.65 | **＋1360.79** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 124.0 | 0.5137 | −0.0164 | ＋1432.32 | **＋1331.48** | 2/5 ＋＋−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -319.14bp ≤ 0。rules.md 13-7） | `2026-09-14T20-07-00_trade_ownex_ridgegan_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 32.0 | 0.5124 | ＋0.0236 | ＋1342.07 | **＋1299.28** | 2/5 −−＋−＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T23-35-59_trade_ownex_lgbmgan_a` |
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 32.0 | 0.5127 | ＋0.0076 | ＋1296.97 | **＋1293.65** | 1/5 −−−−＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 124.0 | 0.5111 | ＋0.0057 | ＋1284.26 | **＋1268.11** | 1/5 0−−−＋ | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -382.51bp ≤ 0。rules.md 13-7） | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 32.0 | 0.5112 | −0.0154 | ＋1408.65 | **＋1261.80** | 1/5 −＋−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T20-07-00_trade_ownex_ridgegan_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 124.0 | 0.5101 | −0.0283 | ＋1334.49 | **＋1244.00** | 0/5 0−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -406.61bp ≤ 0。rules.md 13-7） | `2026-09-15T00-50-28_trade_ownex_mlpgan_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 124.0 | 0.5127 | −0.0369 | ＋1330.77 | **＋1171.61** | 2/5 −＋−−＋ | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -479.01bp ≤ 0。rules.md 13-7） | `2026-09-15T07-19-47_trade_ownex_ridgegan16k_a` |
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 124.0 | 0.5111 | ＋0.0057 | ＋1382.68 | **＋1170.84** | 1/5 0−＋−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -479.77bp ≤ 0。rules.md 13-7） | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 32.0 | 0.5112 | −0.0154 | ＋1153.93 | **＋1151.09** | 1/5 ＋−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T20-07-00_trade_ownex_ridgegan_a` |
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 32.0 | 0.5091 | ＋0.0343 | ＋1281.31 | **＋1146.46** | 0/5 0−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T07-19-47_trade_ownex_ridgegan16k_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 32.0 | 0.5084 | −0.0096 | ＋1293.10 | **＋1122.85** | 2/5 −＋＋−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T00-50-28_trade_ownex_mlpgan_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 55 | 35.0 | 0.5184 | −0.0021 | ＋1119.96 | **＋1111.85** | 1/5 −＋−−− | 2 実行・一致 | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -540.17bp ≤ 0。rules.md 13-7） | `2026-09-15T09-42-43_trade_own_ridge_sel7_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 124.0 | 0.5023 | −0.0150 | ＋1157.53 | **＋1101.63** | 0/5 0−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -548.98bp ≤ 0。rules.md 13-7） | `2026-09-15T07-42-56_trade_ownex_lgbmgan16k_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 50 | 16.0 | 0.5159 | −0.0060 | ＋1193.37 | **＋1095.97** | 2/5 −＋−−＋ | 2 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T09-42-43_trade_own_ridge_sel7_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 32.0 | 0.5084 | −0.0096 | ＋1117.41 | **＋1089.81** | 1/5 −−−−＋ | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T00-50-28_trade_ownex_mlpgan_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 124.0 | 0.5052 | ＋0.0076 | ＋1080.51 | **＋1014.82** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -635.79bp ≤ 0。rules.md 13-7） | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 55 | 16.0 | 0.5159 | −0.0060 | ＋1006.08 | **＋994.65** | 1/5 −＋−−− | 2 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T09-42-43_trade_own_ridge_sel7_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 124.0 | 0.5052 | ＋0.0076 | ＋1157.27 | **＋987.20** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -663.42bp ≤ 0。rules.md 13-7） | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 124.0 | 0.5045 | ＋0.0056 | ＋1024.44 | **＋979.43** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -671.19bp ≤ 0。rules.md 13-7） | `2026-09-15T03-07-07_trade_ownex_ridgegan16k_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 124.0 | 0.5047 | ＋0.0046 | ＋1005.39 | **＋959.91** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -690.71bp ≤ 0。rules.md 13-7） | `2026-09-14T15-21-19_trade_ownex_ridgegan_b` |
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 124.0 | 0.5066 | ＋0.0042 | ＋1020.20 | **＋958.13** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -692.48bp ≤ 0。rules.md 13-7） | `2026-09-14T20-05-33_trade_ownex_mlpgan_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 124.0 | 0.5066 | ＋0.0042 | ＋1117.30 | **＋946.16** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -704.45bp ≤ 0。rules.md 13-7） | `2026-09-14T20-05-33_trade_ownex_mlpgan_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 124.0 | 0.5127 | −0.0369 | ＋963.25 | **＋941.44** | 1/5 0＋−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -709.17bp ≤ 0。rules.md 13-7） | `2026-09-15T07-19-47_trade_ownex_ridgegan16k_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 124.0 | 0.5137 | −0.0164 | ＋940.17 | **＋932.55** | 1/5 0＋−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -718.06bp ≤ 0。rules.md 13-7） | `2026-09-14T20-07-00_trade_ownex_ridgegan_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 124.0 | 0.5066 | −0.0004 | ＋1086.55 | **＋915.68** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -734.94bp ≤ 0。rules.md 13-7） | `2026-09-15T04-24-59_trade_ownex_lgbmgan16k_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 124.0 | 0.5023 | −0.0150 | ＋905.49 | **＋902.58** | 1/5 0−−−＋ | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -748.04bp ≤ 0。rules.md 13-7） | `2026-09-15T07-42-56_trade_ownex_lgbmgan16k_a` |
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 32.0 | 0.5056 | −0.0013 | ＋934.74 | **＋896.09** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T20-05-33_trade_ownex_mlpgan_b` |
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 124.0 | 0.5045 | ＋0.0056 | ＋1014.08 | **＋895.10** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -755.52bp ≤ 0。rules.md 13-7） | `2026-09-15T03-07-07_trade_ownex_ridgegan16k_b` |
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 124.0 | 0.5047 | ＋0.0046 | ＋1017.45 | **＋893.62** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -756.99bp ≤ 0。rules.md 13-7） | `2026-09-14T15-21-19_trade_ownex_ridgegan_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 124.0 | 0.5006 | ＋0.0166 | ＋921.47 | **＋880.47** | 0/5 00−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -770.15bp ≤ 0。rules.md 13-7） | `2026-09-14T23-35-59_trade_ownex_lgbmgan_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 32.0 | 0.5066 | −0.0064 | ＋925.38 | **＋868.53** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T15-21-19_trade_ownex_ridgegan_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 32.0 | 0.5186 | ＋0.0181 | ＋879.86 | **＋859.84** | 1/5 ＋−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T07-42-56_trade_ownex_lgbmgan16k_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 124.0 | 0.5052 | ＋0.0076 | ＋886.61 | **＋850.33** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -800.28bp ≤ 0。rules.md 13-7） | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 32.0 | 0.5045 | −0.0077 | ＋868.48 | **＋815.65** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 32.0 | 0.5063 | −0.0062 | ＋855.68 | **＋803.07** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T03-07-07_trade_ownex_ridgegan16k_b` |
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 124.0 | 0.5066 | −0.0004 | ＋846.89 | **＋802.75** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -847.86bp ≤ 0。rules.md 13-7） | `2026-09-15T04-24-59_trade_ownex_lgbmgan16k_b` |
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 124.0 | 0.5066 | ＋0.0042 | ＋833.31 | **＋800.63** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -849.98bp ≤ 0。rules.md 13-7） | `2026-09-14T20-05-33_trade_ownex_mlpgan_b` |
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 124.0 | 0.5059 | ＋0.0026 | ＋966.35 | **＋799.67** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -850.95bp ≤ 0。rules.md 13-7） | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 124.0 | 0.5006 | ＋0.0166 | ＋802.62 | **＋792.37** | 0/5 0−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -858.25bp ≤ 0。rules.md 13-7） | `2026-09-14T23-35-59_trade_ownex_lgbmgan_a` |
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 124.0 | 0.5059 | ＋0.0026 | ＋873.02 | **＋791.77** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -858.84bp ≤ 0。rules.md 13-7） | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b` |
...
| — | T3 QUANT（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 60 | 60.0 | 0.5219 | ＋0.0070 | ＋789.02 | **＋787.03** | 1/5 ＋−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -864.98bp ≤ 0。rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 32.0 | 0.5063 | −0.0062 | ＋804.01 | **＋779.31** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T03-07-07_trade_ownex_ridgegan16k_b` |
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 32.0 | 0.5059 | −0.0025 | ＋816.67 | **＋774.42** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 124.0 | 0.5045 | ＋0.0056 | ＋801.62 | **＋771.61** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -879.00bp ≤ 0。rules.md 13-7） | `2026-09-15T03-07-07_trade_ownex_ridgegan16k_b` |
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 32.0 | 0.5124 | ＋0.0236 | ＋794.16 | **＋770.45** | 1/5 −−＋−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T23-35-59_trade_ownex_lgbmgan_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 32.0 | 0.5066 | −0.0064 | ＋787.82 | **＋761.08** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T15-21-19_trade_ownex_ridgegan_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 124.0 | 0.5066 | −0.0004 | ＋834.09 | **＋756.34** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -894.27bp ≤ 0。rules.md 13-7） | `2026-09-15T04-24-59_trade_ownex_lgbmgan16k_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 32.0 | 0.5084 | −0.0096 | ＋746.60 | **＋739.46** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T00-50-28_trade_ownex_mlpgan_a` |
...
| — | T3 QUANT（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 55 | 60.0 | 0.5219 | ＋0.0070 | ＋733.67 | **＋730.07** | 1/5 0＋−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -921.95bp ≤ 0。rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 124.0 | 0.5047 | ＋0.0046 | ＋751.46 | **＋721.66** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -928.96bp ≤ 0。rules.md 13-7） | `2026-09-14T15-21-19_trade_ownex_ridgegan_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 124.0 | 0.5059 | ＋0.0026 | ＋762.05 | **＋714.73** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -935.88bp ≤ 0。rules.md 13-7） | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 60 | 35.0 | 0.5184 | −0.0021 | ＋711.05 | **＋708.29** | 1/5 ＋−−−− | 2 実行・一致 | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -943.72bp ≤ 0。rules.md 13-7） | `2026-09-15T09-42-43_trade_own_ridge_sel7_a` |
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 32.0 | 0.5056 | −0.0013 | ＋728.35 | **＋708.27** | 1/5 −−＋−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T20-05-33_trade_ownex_mlpgan_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 32.0 | 0.5066 | −0.0064 | ＋873.47 | **＋703.36** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T15-21-19_trade_ownex_ridgegan_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 32.0 | 0.5063 | −0.0062 | ＋837.33 | **＋673.36** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T03-07-07_trade_ownex_ridgegan16k_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 32.0 | 0.5059 | −0.0025 | ＋690.19 | **＋667.81** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 32.0 | 0.5056 | −0.0013 | ＋808.94 | **＋667.23** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T20-05-33_trade_ownex_mlpgan_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 32.0 | 0.5045 | −0.0077 | ＋751.75 | **＋628.11** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b` |
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 32.0 | 0.5028 | −0.0098 | ＋681.01 | **＋626.24** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T04-24-59_trade_ownex_lgbmgan16k_b` |
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 32.0 | 0.5059 | −0.0025 | ＋772.96 | **＋626.22** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | MLP+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 32.0 | 0.5127 | ＋0.0076 | ＋620.59 | **＋619.43** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 60 | 16.0 | 0.5159 | −0.0060 | ＋583.89 | **＋579.77** | 0/5 −−−−− | 2 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T09-42-43_trade_own_ridge_sel7_a` |
...
| — | T1 MiniRocket（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 55 | 60.0 | 0.5203 | ＋0.0035 | ＋558.89 | **＋556.91** | 0/5 0−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1095.11bp ≤ 0。rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
...
| — | T2 Hydra（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 55 | 60.0 | 0.5206 | −0.0058 | ＋525.52 | **＋523.63** | 0/5 0−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1128.38bp ≤ 0。rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 32.0 | 0.5045 | −0.0077 | ＋542.37 | **＋511.76** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 32.0 | 0.5028 | −0.0098 | ＋640.22 | **＋507.30** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T04-24-59_trade_ownex_lgbmgan16k_b` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 124.0 | 0.5137 | −0.0164 | ＋504.39 | **＋502.76** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1147.85bp ≤ 0。rules.md 13-7） | `2026-09-14T20-07-00_trade_ownex_ridgegan_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 124.0 | 0.5023 | −0.0150 | ＋479.30 | **＋477.30** | 1/5 ＋−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1173.32bp ≤ 0。rules.md 13-7） | `2026-09-15T07-42-56_trade_ownex_lgbmgan16k_a` |
...
| — | 乱択（基準） | 基準線 | ✅ | LightGBM+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 32.0 | 0.5028 | −0.0098 | ＋430.79 | **＋400.30** | 0/5 −−−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T04-24-59_trade_ownex_lgbmgan16k_b` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 32.0 | 0.5091 | ＋0.0343 | ＋336.97 | **＋330.91** | 1/5 −＋−−− | — | 基準 | ⚠ 採否の対象ではない | `2026-09-15T07-19-47_trade_ownex_ridgegan16k_a` |
| — | 全部使う（基準） | 基準線 | ✅ | LightGBM+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 124.0 | 0.5006 | ＋0.0166 | ＋322.17 | **＋320.23** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1330.39bp ≤ 0。rules.md 13-7） | `2026-09-14T23-35-59_trade_ownex_lgbmgan_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge+GAN増強(batch16k) | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 124.0 | 0.5127 | −0.0369 | ＋249.21 | **＋245.09** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1405.52bp ≤ 0。rules.md 13-7） | `2026-09-15T07-19-47_trade_ownex_ridgegan16k_a` |
...
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | F3 埋め込み型 | ✅ | Ridge | adjusted | 2018-06-15 | 日足 | 1 本（1 日） | own ex | 毎日往復 | 共通 | — | — | 1.2 | 0.5100 | ＋0.0232 | ＋7.59 | **＋2.59** | 1/5 ＋−−−− | — | **保留** | ⚠ 平均だけ正。fold の符号が割れる（rules.md 11 章 規約 5） ／ ⚠ **閉じる（2026-09-11・再測しない）**: 検出限界の 2 桁下で、再現幅（4.81bp）が平均（+2.59bp）を上回る（[validation-power.md §6-2](validation-power.md)） | `2026-09-10T16-18-54_impact_ex_2018` |
...
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | F3 埋め込み型 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own ex | 毎日往復 | 共通 | — | — | 1.0 | 0.5109 | ＋0.0366 | ＋5.61 | **＋0.61** | 1/5 ＋−−−− | ⚠ **4 実行・幅 2.84bp** | **保留** | ⚠ 平均だけ正。fold の符号が割れる（rules.md 11 章 規約 5） | `2026-09-09T10-39-59_exog_h1` |
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | F3 埋め込み型 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 毎日往復 | 共通 | — | — | 1.0 | 0.5109 | ＋0.0366 | ＋5.61 | **＋0.61** | 1/5 ＋−−−− | — | **保留** | ⚠ 平均だけ正。fold の符号が割れる（rules.md 11 章 規約 5） | `2026-09-09T10-13-41_own_2018` |
...
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | F3 埋め込み型 | ✅ | Ridge | raw | 1995-02-10 | 日足 | 1 本（1 日） | own | 毎日往復 | 共通 | — | — | 5.0 | 0.5095 | ＋0.0250 | ＋4.64 | **−0.36** | 3/5 ＋−−＋＋ | 2 実行・一致 | **保留** | ⚠ **無効・要再測**（分割調整の誤り。§6-3） | `2026-09-08T17-08-20_own_only_h1` |
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | F3 埋め込み型 | ✅ | Ridge | raw | — | 日足 | 1 本（1 日） | own | 毎日往復 | 共通 | — | — | 5.0 | 0.5095 | ＋0.0250 | ＋4.64 | **−0.36** | 3/5 ＋−−＋＋ | — | **保留** | ⚠ **無効・要再測**（分割調整の誤り。§6-3） | `2026-09-08T16-42-04__repro_oldcsv` |
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | F3 埋め込み型 | ✅ | Ridge | raw | — | 日足 | 1 本（1 日） | own | 毎日往復 | 共通 | — | — | 5.0 | 0.5095 | ＋0.0250 | ＋4.64 | **−0.36** | — | — | **保留** | ⚠ **無効・要再測**（分割調整の誤り。§6-3） | `legacy-daily-h1` |
...
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | F3 埋め込み型 | ✅ | Ridge | adjusted | 2018-06-15 | 日足 | 1 本（1 日） | own | 毎日往復 | 共通 | — | — | 2.2 | 0.5018 | ＋0.0043 | ＋2.20 | **−2.80** | 1/5 ＋−−−− | — | **落とす** | **X2** コストで消える | `2026-09-10T16-18-03_own_impact_2018` |
...
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | F3 埋め込み型 | ✅ | Ridge | adjusted | 2018-06-15 | 日足 | 1 本（1 日） | own im | 毎日往復 | 共通 | — | — | 1.0 | 0.5004 | ＋0.0020 | ＋1.40 | **−3.60** | 0/5 −−−−− | ⚠ **3 実行・幅 1.00bp** | **落とす** | **X2** コストで消える | `2026-09-10T16-22-12_impact_both_2018` |
...
| — | T2 Hydra（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 60 | 60.0 | 0.5206 | −0.0058 | −7.03 | **−7.07** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1659.09bp ≤ 0。rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
...
| — | 全部使う（基準） | 基準線 | ✅ | MLP+GAN増強 | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 124.0 | 0.5101 | −0.0283 | −24.69 | **−25.91** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1676.53bp ≤ 0。rules.md 13-7） | `2026-09-15T00-50-28_trade_ownex_mlpgan_a` |
| — | T1 MiniRocket（60日窓） | 検知器 | ✅ | Ridge | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 60 | 60.0 | 0.5203 | ＋0.0035 | −51.74 | **−51.86** | 0/5 −−−−− | — | **落とす** | ⚠ **基準線以下 ＝ 何も学んでいない**（対 B&H 上乗せ -1703.88bp ≤ 0。rules.md 13-7） | `2026-09-15T10-38-12_trade_ownseq_ridge_a` |
...
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 50 | 0.0 | 0.4978 | −0.0104 | ＋336.15 | **−117.23** | 1/5 −−＋−− | 9 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 55 | 0.0 | 0.4978 | −0.0104 | ＋336.15 | **−117.23** | 1/5 −−＋−− | 9 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 共通 | std | 60 | 0.0 | 0.4978 | −0.0104 | ＋336.15 | **−117.23** | 1/5 −−＋−− | 9 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T08-08-43_trade_ownex_mlpgan16k_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 50 | 0.0 | 0.4978 | −0.0104 | ＋336.15 | **−117.23** | 1/5 −−＋−− | 9 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 55 | 0.0 | 0.4978 | −0.0104 | ＋336.15 | **−117.23** | 1/5 −−＋−− | 9 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own cs rel ex | 閾値売買 | 銘柄別 | std | 60 | 0.0 | 0.4978 | −0.0104 | ＋336.15 | **−117.23** | 1/5 −−＋−− | 9 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T05-58-42_trade_ownex_mlpgan16k_b` |
...
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 50 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 12 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T09-48-15_trade_own_lgbm_sel7_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 55 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 12 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T09-48-15_trade_own_lgbm_sel7_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own | 閾値売買 | 共通 | std | 60 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 12 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T09-48-15_trade_own_lgbm_sel7_a` |
...
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 50 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 2 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T14-04-35_trade_ownseq_patchtst_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 55 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 2 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T14-04-35_trade_ownseq_patchtst_a` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 2018-01-31 | 日足 | 1 本（1 日） | own seq | 閾値売買 | 共通 | std | 60 | 0.0 | 0.4974 | −0.0127 | ＋287.86 | **−165.74** | 1/5 −−＋−− | 2 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-15T14-04-35_trade_ownseq_patchtst_a` |
...
| — | 全部使う（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.9804 | ＋0.6805 | ＋25915.18 | ＋25466.75 | `2026-09-14T23-38-06_trade_ownex_lgbmgan_a_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.9804 | ＋0.6805 | ＋25917.53 | ＋25466.48 | `2026-09-14T23-38-06_trade_ownex_lgbmgan_a_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.9804 | ＋0.6805 | ＋25918.71 | ＋25464.58 | `2026-09-14T23-38-06_trade_ownex_lgbmgan_a_leak` |
...
| — | 全部使う（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.9670 | ＋0.6927 | ＋25846.34 | ＋25399.74 | `2026-09-15T07-54-50_trade_ownex_lgbmgan16k_a_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.9670 | ＋0.6927 | ＋25850.62 | ＋25399.09 | `2026-09-15T07-54-50_trade_ownex_lgbmgan16k_a_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.9670 | ＋0.6927 | ＋25852.11 | ＋25396.26 | `2026-09-15T07-54-50_trade_ownex_lgbmgan16k_a_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.9526 | ＋0.6889 | ＋25732.82 | ＋25279.31 | `2026-09-15T04-30-06_trade_ownex_lgbmgan16k_b_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.9526 | ＋0.6889 | ＋25725.96 | ＋25277.59 | `2026-09-15T04-30-06_trade_ownex_lgbmgan16k_b_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.9526 | ＋0.6889 | ＋25718.80 | ＋25275.55 | `2026-09-15T04-30-06_trade_ownex_lgbmgan16k_b_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.9494 | ＋0.6891 | ＋25704.12 | ＋25251.10 | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.9494 | ＋0.6891 | ＋25696.55 | ＋25248.49 | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b_leak` |
| — | 全部使う（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.9494 | ＋0.6891 | ＋25689.53 | ＋25247.03 | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b_leak` |
| — | 全部使う（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.9472 | ＋0.7071 | ＋25672.28 | ＋25224.46 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 全部使う（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.9472 | ＋0.7071 | ＋25678.43 | ＋25223.44 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 全部使う（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.9472 | ＋0.7071 | ＋25661.78 | ＋25221.77 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 全部使う（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.9347 | ＋0.7013 | ＋25459.40 | ＋25019.54 | `2026-09-14T20-08-58_trade_ownex_ridgegan_a_leak` |
| — | 全部使う（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.9353 | ＋0.6771 | ＋25447.85 | ＋25004.14 | `2026-09-15T03-11-28_trade_ownex_ridgegan16k_b_leak` |
| — | 全部使う（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.9347 | ＋0.7013 | ＋25436.81 | ＋25003.87 | `2026-09-14T20-08-58_trade_ownex_ridgegan_a_leak` |
| — | 全部使う（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.9353 | ＋0.6771 | ＋25439.31 | ＋24999.88 | `2026-09-15T03-11-28_trade_ownex_ridgegan16k_b_leak` |
| — | 全部使う（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.9353 | ＋0.6771 | ＋25424.61 | ＋24989.24 | `2026-09-15T03-11-28_trade_ownex_ridgegan16k_b_leak` |
| — | 全部使う（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.9347 | ＋0.7013 | ＋25412.10 | ＋24986.11 | `2026-09-14T20-08-58_trade_ownex_ridgegan_a_leak` |
| — | 全部使う（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.9245 | ＋0.7026 | ＋25422.21 | ＋24965.83 | `2026-09-15T07-29-00_trade_ownex_ridgegan16k_a_leak` |
| — | 全部使う（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.9245 | ＋0.7026 | ＋25412.15 | ＋24963.95 | `2026-09-15T07-29-00_trade_ownex_ridgegan16k_a_leak` |
| — | 全部使う（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.9245 | ＋0.7026 | ＋25390.09 | ＋24951.00 | `2026-09-15T07-29-00_trade_ownex_ridgegan16k_a_leak` |
| — | 全部使う（基準） | MLP+GAN増強 | adjusted | 日足 | 0.9247 | ＋0.7123 | ＋25299.65 | ＋24855.87 | `2026-09-15T00-53-54_trade_ownex_mlpgan_a_leak` |
| — | 全部使う（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.9222 | ＋0.6793 | ＋25286.22 | ＋24844.82 | `2026-09-14T15-21-19_trade_ownex_ridgegan_b_leak` |
| — | 全部使う（基準） | MLP+GAN増強 | adjusted | 日足 | 0.9247 | ＋0.7123 | ＋25273.06 | ＋24839.27 | `2026-09-15T00-53-54_trade_ownex_mlpgan_a_leak` |
| — | 全部使う（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.9222 | ＋0.6793 | ＋25268.89 | ＋24832.98 | `2026-09-14T15-21-19_trade_ownex_ridgegan_b_leak` |
| — | 全部使う（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.9222 | ＋0.6793 | ＋25243.75 | ＋24813.81 | `2026-09-14T15-21-19_trade_ownex_ridgegan_b_leak` |
| — | 全部使う（基準） | MLP+GAN増強 | adjusted | 日足 | 0.9247 | ＋0.7123 | ＋25232.38 | ＋24808.86 | `2026-09-15T00-53-54_trade_ownex_mlpgan_a_leak` |
...
| — | 全部使う（基準） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6640 | ＋24299.29 | ＋23846.62 | `2026-09-15T09-45-27_trade_own_ridge_sel7_a_leak` |
...
| — | T3 QUANT（60日窓） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6641 | ＋24299.30 | ＋23846.58 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
| — | T1 MiniRocket（60日窓） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6638 | ＋24299.32 | ＋23846.37 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
...
| — | T2 Hydra（60日窓） | Ridge | adjusted | 日足 | 0.9997 | ＋0.6631 | ＋24299.36 | ＋23846.20 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
| — | T1 MiniRocket（60日窓） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6638 | ＋24299.37 | ＋23846.07 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
| — | 全部使う（基準） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6640 | ＋24299.36 | ＋23846.04 | `2026-09-15T09-45-27_trade_own_ridge_sel7_a_leak` |
...
| — | T3 QUANT（60日窓） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6641 | ＋24299.36 | ＋23846.04 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
...
| — | T2 Hydra（60日窓） | Ridge | adjusted | 日足 | 0.9997 | ＋0.6631 | ＋24299.39 | ＋23845.96 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
...
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | LightGBM | adjusted | 日足 | 1.0000 | ＋0.6640 | ＋24299.43 | ＋23845.87 | `2026-09-13T10-44-50_sel_lgbm_two_leak` |
| — | T1 MiniRocket（60日窓） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6638 | ＋24299.38 | ＋23845.77 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
| — | T2 Hydra（60日窓） | Ridge | adjusted | 日足 | 0.9997 | ＋0.6631 | ＋24299.39 | ＋23845.77 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
| — | T3 QUANT（60日窓） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6641 | ＋24299.38 | ＋23845.76 | `2026-09-15T10-55-17_trade_ownseq_ridge_a_leak` |
| — | 全部使う（基準） | Ridge | adjusted | 日足 | 0.9996 | ＋0.6640 | ＋24299.37 | ＋23845.75 | `2026-09-15T09-45-27_trade_own_ridge_sel7_a_leak` |
...
| — | 全部使う（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.7427 | ＋0.5649 | ＋17776.75 | ＋17408.28 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
| — | 入口D1(20)×出口D2(60)（学習） | Ridge | adjusted | 日足 | 0.5684 | ＋0.1548 | ＋17706.78 | ＋17178.22 | `2026-09-12T18-38-52_trend_pairs_1995_leak` |
| — | 全部使う（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.7427 | ＋0.5649 | ＋17494.26 | ＋17159.40 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
...
| — | 全部使う（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.7427 | ＋0.5649 | ＋17201.53 | ＋16895.31 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
...
| — | 全部使う（基準） | MLP+GAN増強 | adjusted | 日足 | 0.6601 | ＋0.4464 | ＋12902.53 | ＋12596.23 | `2026-09-14T20-05-54_trade_ownex_mlpgan_b_leak` |
| — | D2 中期ゲート（60日・学習） | Ridge | adjusted | 日足 | 0.5408 | ＋0.0866 | ＋12533.30 | ＋12360.37 | `2026-09-12T17-54-55_trend_scales_1995_us70_leak` |
| — | 全部使う（基準） | MLP+GAN増強 | adjusted | 日足 | 0.6601 | ＋0.4464 | ＋12615.48 | ＋12356.07 | `2026-09-14T20-05-54_trade_ownex_mlpgan_b_leak` |
...
| — | 全部使う（基準） | MLP+GAN増強 | adjusted | 日足 | 0.6601 | ＋0.4464 | ＋12338.17 | ＋12109.07 | `2026-09-14T20-05-54_trade_ownex_mlpgan_b_leak` |
...
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-10T20-06-42_trade_own_lgbm_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-10T20-06-42_trade_own_lgbm_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-15T09-51-08_trade_own_lgbm_sel7_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-15T09-51-08_trade_own_lgbm_sel7_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-15T09-51-08_trade_own_lgbm_sel7_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-14T10-08-36_trade_own_mlpgan16k_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-14T10-08-36_trade_own_mlpgan16k_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-14T10-08-36_trade_own_mlpgan16k_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-15T14-04-41_trade_ownseq_patchtst_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-15T14-04-41_trade_ownseq_patchtst_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5216 | 0.0000 | ＋1657.02 | ＋1652.02 | `2026-09-15T14-04-41_trade_ownseq_patchtst_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5174 | 0.0000 | ＋1656.01 | ＋1650.62 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5174 | 0.0000 | ＋1656.01 | ＋1650.62 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5174 | 0.0000 | ＋1656.01 | ＋1650.62 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5174 | 0.0000 | ＋1656.01 | ＋1650.62 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5174 | 0.0000 | ＋1656.01 | ＋1650.62 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
| — | 常に上（ドリフト） | — | adjusted | 日足 | 0.5174 | 0.0000 | ＋1656.01 | ＋1650.62 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
...
| — | 入口C3(200)×出口C2(60)（古典） | Ridge | adjusted | 日足 | 0.5090 | −0.0037 | ＋2163.76 | ＋1637.24 | `2026-09-12T20-38-35_trend_pairs_1995_leak` |
| — | 入口C3(200)×出口C2(60)（古典） | Ridge | adjusted | 日足 | 0.5090 | −0.0037 | ＋2163.76 | ＋1637.24 | `2026-09-12T20-38-35_trend_pairs_1995_leak` |
| — | 乱択（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.5159 | −0.0155 | ＋1624.31 | ＋1616.83 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
...
| — | 乱択（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.5118 | ＋0.0012 | ＋1488.49 | ＋1397.38 | `2026-09-14T20-08-58_trade_ownex_ridgegan_a_leak` |
...
| — | C2 中期 SMA60 フィルタ | Ridge | adjusted | 日足 | 0.5012 | −0.0045 | ＋1591.13 | ＋1377.28 | `2026-09-13T09-03-10_trend_scales_1995_us74_leak` |
| — | C2 中期 SMA60 フィルタ | Ridge | adjusted | 日足 | 0.5012 | −0.0045 | ＋1591.13 | ＋1377.28 | `2026-09-13T09-03-10_trend_scales_1995_us74_leak` |
| — | 乱択（基準） | Ridge | adjusted | 日足 | 0.5182 | ＋0.0004 | ＋1458.88 | ＋1358.21 | `2026-09-15T09-45-27_trade_own_ridge_sel7_a_leak` |
...
| — | 乱択（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.5153 | −0.0154 | ＋1289.78 | ＋1269.46 | `2026-09-14T23-38-06_trade_ownex_lgbmgan_a_leak` |
| — | 乱択（基準） | Ridge | adjusted | 日足 | 0.5182 | ＋0.0004 | ＋1269.42 | ＋1262.77 | `2026-09-15T09-45-27_trade_own_ridge_sel7_a_leak` |
| — | 乱択（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.5153 | −0.0154 | ＋1370.25 | ＋1255.61 | `2026-09-14T23-38-06_trade_ownex_lgbmgan_a_leak` |
...
| — | 乱択（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.5107 | ＋0.0183 | ＋1277.62 | ＋1175.70 | `2026-09-15T07-54-50_trade_ownex_lgbmgan16k_a_leak` |
| — | 乱択（基準） | MLP+GAN増強 | adjusted | 日足 | 0.5140 | −0.0005 | ＋1341.38 | ＋1172.98 | `2026-09-15T00-53-54_trade_ownex_mlpgan_a_leak` |
...
| — | 入口C3(200)×出口C1(20)（古典） | Ridge | adjusted | 日足 | 0.5090 | −0.0037 | ＋1917.12 | ＋1116.72 | `2026-09-12T20-38-35_trend_pairs_1995_leak` |
| — | 入口C3(200)×出口C1(20)（古典） | Ridge | adjusted | 日足 | 0.5090 | −0.0037 | ＋1917.12 | ＋1116.72 | `2026-09-12T20-38-35_trend_pairs_1995_leak` |
| — | 乱択（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.5153 | −0.0154 | ＋1101.05 | ＋1092.09 | `2026-09-14T23-38-06_trade_ownex_lgbmgan_a_leak` |
...
| — | 乱択（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.5025 | ＋0.0040 | ＋1178.63 | ＋1037.74 | `2026-09-15T07-29-00_trade_ownex_ridgegan16k_a_leak` |
| — | 乱択（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.5107 | ＋0.0183 | ＋1040.74 | ＋1021.34 | `2026-09-15T07-54-50_trade_ownex_lgbmgan16k_a_leak` |
| — | 乱択（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.5081 | ＋0.0031 | ＋1060.26 | ＋1011.68 | `2026-09-14T15-21-19_trade_ownex_ridgegan_b_leak` |
| — | 乱択（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.5025 | ＋0.0040 | ＋1021.31 | ＋1011.56 | `2026-09-15T07-29-00_trade_ownex_ridgegan16k_a_leak` |
...
| — | 乱択（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.5159 | −0.0155 | ＋975.05 | ＋973.01 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 乱択（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.5057 | −0.0017 | ＋1098.16 | ＋966.81 | `2026-09-15T04-30-06_trade_ownex_lgbmgan16k_b_leak` |
| — | 乱択（基準） | LightGBM | adjusted | 日足 | 0.5201 | ＋0.0173 | ＋968.04 | ＋961.83 | `2026-09-15T09-51-08_trade_own_lgbm_sel7_a_leak` |
| — | 乱択（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.5080 | ＋0.0013 | ＋984.07 | ＋950.05 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
| — | 乱択（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.5067 | ＋0.0040 | ＋980.21 | ＋929.83 | `2026-09-15T03-11-28_trade_ownex_ridgegan16k_b_leak` |
| — | 乱択（基準） | MLP+GAN増強 | adjusted | 日足 | 0.5079 | −0.0012 | ＋1054.64 | ＋925.79 | `2026-09-14T20-05-54_trade_ownex_mlpgan_b_leak` |
...
| — | C1 短期 SMA20 フィルタ | Ridge | adjusted | 日足 | 0.4969 | −0.0058 | ＋1300.50 | ＋916.52 | `2026-09-13T09-03-10_trend_scales_1995_us74_leak` |
| — | C1 短期 SMA20 フィルタ | Ridge | adjusted | 日足 | 0.4969 | −0.0058 | ＋1300.50 | ＋916.52 | `2026-09-13T09-03-10_trend_scales_1995_us74_leak` |
| — | 乱択（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.5081 | ＋0.0031 | ＋1072.22 | ＋914.89 | `2026-09-14T15-21-19_trade_ownex_ridgegan_b_leak` |
| — | 乱択（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.5118 | ＋0.0012 | ＋922.43 | ＋914.16 | `2026-09-14T20-08-58_trade_ownex_ridgegan_a_leak` |
| — | 乱択（基準） | MLP+GAN増強 | adjusted | 日足 | 0.5140 | −0.0005 | ＋921.57 | ＋910.38 | `2026-09-15T00-53-54_trade_ownex_mlpgan_a_leak` |
...
| — | 乱択（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.5080 | ＋0.0013 | ＋1038.63 | ＋904.68 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
...
| — | 乱択（基準） | MLP+GAN増強 | adjusted | 日足 | 0.5079 | −0.0012 | ＋914.36 | ＋882.57 | `2026-09-14T20-05-54_trade_ownex_mlpgan_b_leak` |
...
| — | 乱択（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.5057 | −0.0017 | ＋921.66 | ＋864.24 | `2026-09-15T04-30-06_trade_ownex_lgbmgan16k_b_leak` |
| — | 乱択（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.5067 | ＋0.0040 | ＋879.76 | ＋857.76 | `2026-09-15T03-11-28_trade_ownex_ridgegan16k_b_leak` |
| — | 乱択（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.5118 | ＋0.0012 | ＋872.15 | ＋852.04 | `2026-09-14T20-08-58_trade_ownex_ridgegan_a_leak` |
| — | 乱択（基準） | Ridge+GAN増強 | adjusted | 日足 | 0.5081 | ＋0.0031 | ＋859.38 | ＋837.16 | `2026-09-14T15-21-19_trade_ownex_ridgegan_b_leak` |
| — | 乱択（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.5067 | ＋0.0040 | ＋998.92 | ＋833.17 | `2026-09-15T03-11-28_trade_ownex_ridgegan16k_b_leak` |
| — | 乱択（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.5034 | −0.0043 | ＋878.67 | ＋823.66 | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b_leak` |
...
| — | 乱択（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.5057 | −0.0017 | ＋737.37 | ＋702.95 | `2026-09-15T04-30-06_trade_ownex_lgbmgan16k_b_leak` |
| — | 乱択（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.5034 | −0.0043 | ＋822.62 | ＋700.94 | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b_leak` |
...
| — | 乱択（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.5080 | ＋0.0013 | ＋703.66 | ＋685.47 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
...
| — | 乱択（基準） | Ridge | adjusted | 日足 | 0.5182 | ＋0.0004 | ＋657.66 | ＋655.31 | `2026-09-15T09-45-27_trade_own_ridge_sel7_a_leak` |
| — | 乱択（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.5089 | −0.0054 | ＋657.51 | ＋644.88 | `2026-09-14T06-20-48_trade_own_ridgegan16k_b_leak` |
| — | 乱択（基準） | MLP+GAN増強 | adjusted | 日足 | 0.5140 | −0.0005 | ＋648.58 | ＋644.12 | `2026-09-15T00-53-54_trade_ownex_mlpgan_a_leak` |
| — | 乱択（基準） | MLP+GAN増強(batch16k) | adjusted | 日足 | 0.5159 | −0.0155 | ＋641.01 | ＋640.11 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
...
| — | 乱択（基準） | LightGBM+GAN増強 | adjusted | 日足 | 0.5034 | −0.0043 | ＋638.06 | ＋605.59 | `2026-09-14T15-21-19_trade_ownex_lgbmgan_b_leak` |
| — | 乱択（基準） | MLP+GAN増強 | adjusted | 日足 | 0.5079 | −0.0012 | ＋600.63 | ＋584.50 | `2026-09-14T20-05-54_trade_ownex_mlpgan_b_leak` |
| — | 乱択（基準） | Ridge+GAN増強(batch16k) | adjusted | 日足 | 0.5025 | ＋0.0040 | ＋584.92 | ＋582.21 | `2026-09-15T07-29-00_trade_ownex_ridgegan16k_a_leak` |
...
| — | 乱択（基準） | LightGBM+GAN増強(batch16k) | adjusted | 日足 | 0.5107 | ＋0.0183 | ＋297.62 | ＋292.34 | `2026-09-15T07-54-50_trade_ownex_lgbmgan16k_a_leak` |
...
| F3-1 | Lasso・Elastic Net（実装は 0 本→先頭列） | Ridge | adjusted | 日足 | 0.9967 | ＋1.0000 | ＋130.63 | ＋125.63 | `2026-09-09T00-58-46_exog_h1_leak` |
...
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4978 | −0.0104 | ＋336.15 | −117.23 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4978 | −0.0104 | ＋336.15 | −117.23 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4978 | −0.0104 | ＋336.15 | −117.23 | `2026-09-15T08-21-23_trade_ownex_mlpgan16k_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4978 | −0.0104 | ＋336.15 | −117.23 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4978 | −0.0104 | ＋336.15 | −117.23 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4978 | −0.0104 | ＋336.15 | −117.23 | `2026-09-15T06-03-04_trade_ownex_mlpgan16k_b_leak` |
...
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-10T20-06-42_trade_own_lgbm_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-10T20-06-42_trade_own_lgbm_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-15T09-51-08_trade_own_lgbm_sel7_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-15T09-51-08_trade_own_lgbm_sel7_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-15T09-51-08_trade_own_lgbm_sel7_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-14T10-08-36_trade_own_mlpgan16k_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-14T10-08-36_trade_own_mlpgan16k_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-14T10-08-36_trade_own_mlpgan16k_b_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-15T14-04-41_trade_ownseq_patchtst_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-15T14-04-41_trade_ownseq_patchtst_a_leak` |
| — | 直前リターンの符号 | — | adjusted | 日足 | 0.4974 | −0.0127 | ＋287.86 | −165.74 | `2026-09-15T14-04-41_trade_ownseq_patchtst_a_leak` |
...
| 3 | ⚠ **「未実施」は「効かない」ではない** | ⚠ **12 件は情報が無いだけである。**⚠ **落とした 493 行と混同しない** |
