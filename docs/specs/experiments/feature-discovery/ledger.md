...
⚠ **試行は 58 行（手法）＋ 23 行（基準線）。** ⚠ **「採る」は 0 件。** 落とす 41 行 ／ 保留 17 行。

⚠ **保留の内訳**: 無効・要再測（日足 × `raw`）が 9 行 ／ ⚠ **純利は正だが fold の符号が割れる**ものが 8 行。⚠ **後者は「採る」の一歩手前ではない。** ⚠ **多重検定を通していない良い数字である**（[rules.md 11 章](rules.md) 規約 2・3）。
...
⚠ **多重検定に使う `n_trials` は 58**（= 試行の行数。基準線 23 行は数えない。⚠ **「全部使う × Ridge 以外のモデル」はモデルが処置なので試行として数える** — [plans/archive/gpu-models.md §3-4](../../../plans/archive/gpu-models.md)）。⚠ **[rules.md 11 章](rules.md) の規約 4 は「手法 × 粒度 × 地平 × 銘柄集合」を全部数えることを求める。この数を数え落とすと必ず甘くなる。**
...
| F3-1 | Lasso・Elastic Net | F3 埋め込み型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 1.0 | 0.5109 | ＋0.0366 | ＋5.61 | **＋0.61** | 1/5 ＋−−−− | ⚠ **4 実行・幅 2.84bp** | **保留** | ⚠ 平均だけ正。fold の符号が割れる（rules.md 11 章 規約 5） | `2026-09-09T10-39-59_exog_h1` |
...
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 日足 | 1 本（1 日） | own | 0.0 | 0.5211 | 0.0000 | ＋5.02 | **＋0.02** | 3/5 ＋−＋−＋ | ⚠ **7 実行・幅 1.85bp** | 基準 | ⚠ **ほとんど回転しない＝ 実際はコストを払わない** | `2026-09-09T19-30-37_gpu_lgbm_gan_2018` |
...
| — | 常に上（ドリフト） | 基準線 | ✅ | — | adjusted | 日足 | 1 本（1 日） | own ex | 0.0 | 0.5207 | 0.0000 | ＋4.62 | **−0.38** | 3/5 ＋−−＋＋ | 4 実行・一致 | 基準 | ⚠ **ほとんど回転しない＝ 実際はコストを払わない** | `2026-09-09T10-39-59_exog_h1` |
...
| F1-2 | 相互情報量 | F1 フィルタ型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5078 | ＋0.0327 | ＋4.55 | **−0.45** | 1/5 ＋−−−− | ⚠ **4 実行・幅 1.30bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F3-3 | 並べ替え重要度（MDA） | F3 埋め込み型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.5038 | ＋0.0280 | ＋4.23 | **−0.77** | 1/5 ＋−−−− | ⚠ **3 実行・幅 2.81bp** | **落とす** | **X2** コストで消える | `2026-09-09T12-22-33_own_impact_2018` |
...
| F2-3 | Boruta | F2 ラッパー型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 14.2 | 0.5037 | ＋0.0334 | ＋3.67 | **−1.33** | 1/5 ＋−−−− | ⚠ **3 実行・幅 2.48bp** | **落とす** | **X2** コストで消える | `2026-09-09T12-22-33_own_impact_2018` |
...
| F3-5 | クラスタ化 MDA（cMDA） | F3 埋め込み型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5031 | ＋0.0233 | ＋3.54 | **−1.46** | 3/5 ＋＋−−＋ | ⚠ **4 実行・幅 2.73bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F3-2 | 木の分岐重要度（MDI） | F3 埋め込み型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.5029 | ＋0.0233 | ＋3.42 | **−1.58** | 1/5 ＋−−−− | ⚠ **3 実行・幅 2.61bp** | **落とす** | **X2** コストで消える | `2026-09-09T12-22-33_own_impact_2018` |
...
| F3-3 | 並べ替え重要度（MDA） | F3 埋め込み型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5024 | ＋0.0247 | ＋2.51 | **−2.49** | 2/5 ＋＋−−− | ⚠ **4 実行・幅 0.98bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
| F3-5 | クラスタ化 MDA（cMDA） | F3 埋め込み型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.5045 | ＋0.0212 | ＋2.40 | **−2.60** | 1/5 ＋−−−− | ⚠ **3 実行・幅 2.88bp** | **落とす** | **X2** コストで消える | `2026-09-09T12-22-33_own_impact_2018` |
| F1-3 | mRMR（最小冗長・最大関連） | F1 フィルタ型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.4994 | ＋0.0187 | ＋2.32 | **−2.68** | 2/5 ＋−−＋− | ⚠ **4 実行・幅 2.19bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F1-5 | 単変量の仮説検定 ＋ FDR（FRESH） | F1 フィルタ型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 60.0 | 0.5042 | ＋0.0266 | ＋2.07 | **−2.93** | 3/5 ＋＋−＋− | ⚠ **4 実行・幅 1.50bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F2-3 | Boruta | F2 ラッパー型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 38.2 | 0.4996 | ＋0.0191 | ＋1.98 | **−3.02** | 2/5 ＋−−−＋ | ⚠ **4 実行・幅 1.50bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F3-1 | Lasso・Elastic Net | F3 埋め込み型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 1.0 | 0.5017 | ＋0.0042 | ＋1.70 | **−3.30** | 0/5 −−−−− | ⚠ **3 実行・幅 3.91bp** | **落とす** | **X2** コストで消える | `2026-09-09T12-22-33_own_impact_2018` |
| F3-2 | 木の分岐重要度（MDI） | F3 埋め込み型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5018 | ＋0.0139 | ＋1.57 | **−3.43** | 2/5 ＋＋−−− | ⚠ **4 実行・幅 2.85bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| — | 全部使う（基準） | 基準線 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 85.0 | 0.5026 | ＋0.0139 | ＋1.46 | **−3.54** | 1/5 −−−−＋ | ⚠ **4 実行・幅 3.21bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T10-39-59_exog_h1` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5051 | ＋0.0014 | ＋1.32 | **−3.68** | 0/5 −−−−− | ⚠ **4 実行・幅 0.88bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T10-39-59_exog_h1` |
...
| F1-2 | 相互情報量 | F1 フィルタ型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.5009 | ＋0.0176 | ＋1.14 | **−3.86** | 1/5 ＋−−−− | ⚠ **3 実行・幅 0.63bp** | **落とす** | **X2** コストで消える | `2026-09-09T12-22-33_own_impact_2018` |
...
| F1-5 | 単変量の仮説検定 ＋ FDR（FRESH） | F1 フィルタ型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 23.0 | 0.4980 | ＋0.0153 | ＋0.79 | **−4.21** | 1/5 ＋−−−− | ⚠ **3 実行・幅 3.17bp** | **落とす** | **X2** コストで消える | `2026-09-09T12-22-33_own_impact_2018` |
...
| F1-1 | 相関（Pearson・Spearman） | F1 フィルタ型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.4961 | ＋0.0093 | ＋0.69 | **−4.31** | 1/5 ＋−−−− | ⚠ **3 実行・幅 3.13bp** | **落とす** | **X2** コストで消える | `2026-09-09T12-22-33_own_impact_2018` |
| — | 全部使う（基準） | 基準線 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 35.0 | 0.4964 | ＋0.0166 | ＋0.65 | **−4.35** | 1/5 ＋−−−− | ⚠ **3 実行・幅 2.80bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T12-22-33_own_impact_2018` |
...
| — | 乱択（基準） | 基準線 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.5004 | ＋0.0138 | ＋0.45 | **−4.55** | 0/5 −−−−− | ⚠ **3 実行・幅 0.56bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T12-22-33_own_impact_2018` |
| F1-1 | 相関（Pearson・Spearman） | F1 フィルタ型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.4967 | ＋0.0096 | ＋0.41 | **−4.59** | 1/5 ＋−−−− | ⚠ **4 実行・幅 1.72bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F1-3 | mRMR（最小冗長・最大関連） | F1 フィルタ型 | ✅ | Ridge | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.4956 | ＋0.0014 | −1.01 | **−6.01** | 0/5 −−−−− | ⚠ **3 実行・幅 3.75bp** | **落とす** | **X2 ＋ X9** コスト以前に優位性が無い | `2026-09-09T12-22-33_own_impact_2018` |
...
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 日足 | 1 本（1 日） | own ex | 0.0 | 0.4950 | 0.0000 | −3.03 | **−8.03** | 0/5 −−−−− | 4 実行・一致 | 基準 | ⚠ 採否の対象ではない | `2026-09-09T10-39-59_exog_h1` |
| — | 直前リターンの符号 | 基準線 | ✅ | — | adjusted | 日足 | 1 本（1 日） | own | 0.0 | 0.4953 | 0.0000 | −3.20 | **−8.20** | 0/5 −−−−− | ⚠ **7 実行・幅 1.65bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T19-30-37_gpu_lgbm_gan_2018` |
...
| 3 | ⚠ **「未実施」は「効かない」ではない** | ⚠ **16 件は情報が無いだけである。**⚠ **落とした 41 行と混同しない** |
