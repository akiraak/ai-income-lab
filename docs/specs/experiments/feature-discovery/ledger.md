...
⚠ **試行は 45 行（手法）＋ 18 行（基準線）。** ⚠ **「採る」は 0 件。** 落とす 31 行 ／ 保留 14 行。

⚠ **保留の内訳**: 無効・要再測（日足 × `raw`）が 9 行 ／ ⚠ **純利は正だが fold の符号が割れる**ものが 5 行。⚠ **後者は「採る」の一歩手前ではない。** ⚠ **多重検定を通していない良い数字である**（[rules.md 11 章](rules.md) 規約 2・3）。
...
| F3-1 | Lasso・Elastic Net | F3 埋め込み型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 1.0 | 0.5109 | ＋0.0366 | ＋5.61 | **＋0.61** | 1/5 ＋−−−− | ⚠ **2 実行・幅 3.00bp** | **保留** | ⚠ 平均だけ正。fold の符号が割れる（rules.md 11 章 規約 5） | `2026-09-09T10-13-41_own_2018` |
| F3-1 | Lasso・Elastic Net | F3 埋め込み型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 1.0 | 0.5109 | ＋0.0366 | ＋5.61 | **＋0.61** | 1/5 ＋−−−− | ⚠ **4 実行・幅 2.84bp** | **保留** | ⚠ 平均だけ正。fold の符号が割れる（rules.md 11 章 規約 5） | `2026-09-09T10-39-59_exog_h1` |
...
| — | 常に上（ドリフト） | 基準線 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 0.0 | 0.5207 | 0.0000 | ＋4.62 | **−0.38** | 3/5 ＋−−＋＋ | ⚠ **2 実行・幅 1.46bp** | 基準 | ⚠ **ほとんど回転しない＝ 実際はコストを払わない** | `2026-09-09T10-13-41_own_2018` |
...
| F1-2 | 相互情報量 | F1 フィルタ型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5078 | ＋0.0327 | ＋4.55 | **−0.45** | 1/5 ＋−−−− | ⚠ **4 実行・幅 1.30bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F3-5 | クラスタ化 MDA（cMDA） | F3 埋め込み型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5031 | ＋0.0233 | ＋3.54 | **−1.46** | 3/5 ＋＋−−＋ | ⚠ **4 実行・幅 2.73bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F3-3 | 並べ替え重要度（MDA） | F3 埋め込み型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5024 | ＋0.0247 | ＋2.51 | **−2.49** | 2/5 ＋＋−−− | ⚠ **4 実行・幅 0.98bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
| F1-3 | mRMR（最小冗長・最大関連） | F1 フィルタ型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.4994 | ＋0.0187 | ＋2.32 | **−2.68** | 2/5 ＋−−＋− | ⚠ **4 実行・幅 2.19bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F1-5 | 単変量の仮説検定 ＋ FDR（FRESH） | F1 フィルタ型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 60.0 | 0.5042 | ＋0.0266 | ＋2.07 | **−2.93** | 3/5 ＋＋−＋− | ⚠ **4 実行・幅 1.50bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F2-3 | Boruta | F2 ラッパー型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 38.2 | 0.4996 | ＋0.0191 | ＋1.98 | **−3.02** | 2/5 ＋−−−＋ | ⚠ **4 実行・幅 1.50bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| F3-3 | 並べ替え重要度（MDA） | F3 埋め込み型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.5015 | ＋0.0231 | ＋1.71 | **−3.29** | 1/5 ＋−−−− | ⚠ **2 実行・幅 0.30bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-13-41_own_2018` |
| F3-2 | 木の分岐重要度（MDI） | F3 埋め込み型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5018 | ＋0.0139 | ＋1.57 | **−3.43** | 2/5 ＋＋−−− | ⚠ **4 実行・幅 2.85bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
...
| — | 全部使う（基準） | 基準線 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 85.0 | 0.5026 | ＋0.0139 | ＋1.46 | **−3.54** | 1/5 −−−−＋ | ⚠ **4 実行・幅 3.21bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T10-39-59_exog_h1` |
...
| — | 乱択（基準） | 基準線 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.5051 | ＋0.0014 | ＋1.32 | **−3.68** | 0/5 −−−−− | ⚠ **4 実行・幅 0.88bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T10-39-59_exog_h1` |
...
| F2-3 | Boruta | F2 ラッパー型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 12.0 | 0.5051 | ＋0.0228 | ＋1.19 | **−3.81** | 1/5 ＋−−−− | ⚠ **2 実行・幅 0.82bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-13-41_own_2018` |
| — | 乱択（基準） | 基準線 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.4982 | ＋0.0217 | ＋1.01 | **−3.99** | 0/5 −−−−− | ⚠ **2 実行・幅 0.17bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T10-13-41_own_2018` |
| — | 全部使う（基準） | 基準線 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 35.0 | 0.4957 | ＋0.0201 | ＋0.90 | **−4.10** | 0/5 −−−−− | ⚠ **2 実行・幅 2.54bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T10-13-41_own_2018` |
...
| F1-2 | 相互情報量 | F1 フィルタ型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.4990 | ＋0.0165 | ＋0.83 | **−4.17** | 1/5 −−−−＋ | ⚠ **2 実行・幅 0.32bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-13-41_own_2018` |
| F3-2 | 木の分岐重要度（MDI） | F3 埋め込み型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.4991 | ＋0.0167 | ＋0.81 | **−4.19** | 1/5 ＋−−−− | ⚠ **2 実行・幅 1.42bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-13-41_own_2018` |
...
| F1-3 | mRMR（最小冗長・最大関連） | F1 フィルタ型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.4949 | ＋0.0129 | ＋0.65 | **−4.35** | 1/5 ＋−−−− | ⚠ **2 実行・幅 2.10bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-13-41_own_2018` |
| F3-5 | クラスタ化 MDA（cMDA） | F3 埋め込み型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.4989 | ＋0.0193 | ＋0.42 | **−4.58** | 0/5 −−−−− | ⚠ **2 実行・幅 2.88bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-13-41_own_2018` |
| F1-5 | 単変量の仮説検定 ＋ FDR（FRESH） | F1 フィルタ型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 24.4 | 0.4955 | ＋0.0139 | ＋0.41 | **−4.59** | 0/5 −−−−− | ⚠ **2 実行・幅 3.17bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-13-41_own_2018` |
| F1-1 | 相関（Pearson・Spearman） | F1 フィルタ型 | ✅ | adjusted | 日足 | 1 本（1 日） | own ex | 16.0 | 0.4967 | ＋0.0096 | ＋0.41 | **−4.59** | 1/5 ＋−−−− | ⚠ **4 実行・幅 1.72bp** | **落とす** | **X2** コストで消える | `2026-09-09T10-39-59_exog_h1` |
| F1-1 | 相関（Pearson・Spearman） | F1 フィルタ型 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 16.0 | 0.4935 | ＋0.0067 | −0.40 | **−5.40** | 0/5 −−−−− | ⚠ **2 実行・幅 3.13bp** | **落とす** | **X2 ＋ X9** コスト以前に優位性が無い | `2026-09-09T10-13-41_own_2018` |
...
| — | 直前リターンの符号 | 基準線 | ✅ | adjusted | 日足 | 1 本（1 日） | own | 0.0 | 0.4950 | 0.0000 | −3.03 | **−8.03** | 0/5 −−−−− | ⚠ **2 実行・幅 1.48bp** | 基準 | ⚠ 採否の対象ではない | `2026-09-09T10-13-41_own_2018` |
...
| `2026-09-09T10-13-41_own_2018` | runs/ | 日足 | adjusted | 135,962 | 35 | 63 | 0 | `88996e7` | `3d14e78ac1f1d330` | — |
| `2026-09-09T10-18-51_real_2018` | runs/ | 日足 | adjusted | 135,962 | 63 | 63 | 0 | `88996e7` | `3d14e78ac1f1d330` | — |
| `2026-09-09T10-28-35_placebo_2018` | runs/ | 日足 | adjusted | 135,962 | 57 | 63 | 0 | `88996e7` | `3d14e78ac1f1d330` | — |
| `2026-09-09T10-39-59_exog_h1` | runs/ | 日足 | adjusted | 135,962 | 85 | 63 | 0 | `88996e7` | `3d14e78ac1f1d330` | — |
...
| 3 | ⚠ **「未実施」は「効かない」ではない** | ⚠ **16 件は情報が無いだけである。**⚠ **落とした 31 行と混同しない** |
