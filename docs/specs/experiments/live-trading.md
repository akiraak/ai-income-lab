...
| ④ 市場時間中の所要 | ✅（手動の回）／ ⏳ cron の回は 12:55 PDT 以降に足す | 手動の ③ で **日足の更新 56 秒 ＋ 予測 3 本並列 45 秒 ＝ 101 秒 ≤ 120 秒**【実測 2026-09-24 11:03〜11:05 ET・市場時間中・63 銘柄】（予測の内訳 表 38.3〜41.1 秒 ＋ fit 0.15 ／ 2.06 ／ 3.72 秒）。titan の 9/23 は 55 ＋ 43 秒。12:40 PDT の host cron（dry-run）の `logs/trade.log` からも読んで並べる |
