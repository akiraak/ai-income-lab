...
| D7 | 既存コンテンツの AI 学習許諾（声・映像・写真・書籍） | L2 | P6 | ゼロ | 〜3ヶ月 | 在庫が無いのに新規制作すると単価（画像はセント未満/枚）に見合わない | 2026-08-26 追加。集約サービス経由（音声・映像・画像ライブラリ）。副: 9 資源。⚠ **継続分配型（ElevenLabs、L2）と独占売却型（Troveo、実態は E8/D6 に近い）が混在**。声・動画は時間あたり $96〜1,280 で成立、写真は不成立。日本からの受取は未確認（[d7-content-licensing.md](../experiments/d7-content-licensing.md) 2026-08-27） |
