...
| 3'' | D7 | 既存コンテンツの AI 学習許諾 | L2 | **新規** | ゼロ | 既存の声・映像・写真の在庫があれば追加労働ほぼゼロ。無ければ成立しない |
...
| 5 | C4/C5 | 買い切りアプリ・SaaS | L2 | 強化 | ゼロ〜小 | 週 5〜15 時間の第一候補。**I8 の打ち切りにより、時間を使う枠の先頭に繰り上がった**（2026-08-27） |
...
関与度の内訳: L1 が 3、L2 が 4、L3 が 3（I7・I8 の打ち切り分を除く）。L1 だけに寄る偏りはない。
