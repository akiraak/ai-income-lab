...
| 3'' | **D7** | 既存コンテンツの AI 学習許諾 | L2 | **新規** | ゼロ | **2026-08-27 の分析で唯一の残存候補**。声・動画は時間あたり $96〜1,280 で受託を上回る（写真は不成立）。⚠ 日本からの受取が未確認のため採否は保留（[d7-content-licensing.md](../experiments/d7-content-licensing.md)） |
...
| 9 | B14 | AI 開発者向けの評価・RLHF 受託 | L1 | **新規** | ゼロ | 回収は最も確実（$31〜65/時）だが L1 の労働でデータ資産が残らない。⚠ 発注元の都合で供給が消える |

関与度の内訳: L1 が 3、L2 が 2、L3 が 3（I7・I8・C4/C5 の打ち切り分を除く）。

⚠ **2026-08-27 時点で、時間を使う枠は D7 と B14 しか残っていない。**
