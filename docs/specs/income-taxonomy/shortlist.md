...
| F4 | 保険・債務保証 | 州の保険業法。**個人は引受主体になれない**。⚠ **引受リスク自体は証券化されて E1 の板に載っている**（下記）。⚠ **F4 として取るのではなく E1 の一銘柄として扱う** |
...
> ⚠ **2026-08-29: この第 0 段の除外に疑いが出た。** F4「保険の引受・債務保証」を
...
>
> **⚠ 2026-08-31 決着: 除外は維持する。母集団 51 件は変えない。外す理由の書き方だけを直した。**
>
> 除外の理由は「個人は**引受主体**になれない」であり、⚠ **これは今も正しい**（州の保険業法は変わっていない）。
> ILS が示したのは「**引受主体にならずに同じリスクを取れる**」ことで、
> ⚠ **それは F4 を手法として取れるという意味ではなく、引受リスクが証券化されて E1（上場商品）の板に
> 載っているという意味**である。買っているのは保険契約ではなく債券で、入口も出口も課税も E1 のもの。
>
> → **F4 は枠として除外したまま。ILS は E1 の一銘柄**として
> [online-tradable-assets.md §14-3](../online-tradable-assets.md) の一覧に載せてある。
> ⚠ **ILS 自体の型（①②③）は未確定**（分配 8.1% に対し 2026 YTD 1.19%、⚠ 経費率 1.58%、履歴 1.4 年）。
> ⚠ **ただしそれは「この銘柄が良いか」の問いで、「F4 のリスクに到達できるか」とは別。**
> 型の確定を待たずにこの判断は決められた（[§14-16 の 3](../online-tradable-assets.md)）。
