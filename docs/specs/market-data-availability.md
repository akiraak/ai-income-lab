...
| **Masterworks の PPEX ATS が 2026-12-14 に終了** | ⚠ 過去データを終了後も参照できるかの開示が無い |
...
| 4 | 美術品の分割所有 | 作品ごとのシリーズ | S6 | 運営の開示 | T | **L4** | — | ⚠ 2026-12-14 に ATS 終了。**終了後に過去データを参照できるかの開示が無い** |
...
| 対象 | 状況 | 影響 |
| --- | --- | --- |
| **Masterworks**（14-9-4） | 2026-12-14 に PPEX ATS 終了。代替は「掲示板・マッチング等」で未定 | ⚠ **過去データを終了後も参照できるかの開示が無い。**必要なら終了前に確保する判断が要る |
