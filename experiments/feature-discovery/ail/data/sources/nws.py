...
def events(start: str, end: str, pages: int = 20, pause: float = 1.0) -> dict[tuple, dict]:
    ...
    ⚠ **API はメッセージを 7 日しか持たない**【実測 2026-09-16。23:50Z に取って最古が 7 日前の 23:52Z】。
    ⚠ **`NEW` が窓の外へ消えた事象は数えない**（下の注記）。⚠ **Sx360 でも 2026-09-16 に同じ穴を別の直し方で
    塞いでいた**（VTEC の始まりの最小で日付け。2026-09-17 のマージでこちらの直し方に揃えた）。
    """
